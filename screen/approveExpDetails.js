...
const approveExpDetails = ({route,navigation})=>{
  ...
  console.log("allDataApprovedDetails=="+allData);
  ...
  console.log("parseData==="+JSON.stringify(parseData));
    ...
    return (
      ...
      <View style={style.listamt1}><Text  style={style.expdes_amt1}>£450</Text></View>
     ...
     <Text  style={style.expdes_head2}> Description </Text>
      ...
      <View style={style.subdates}>
        ...
        <View style={{width:'50%',}}>
          <Text style={style.datestyleR}>Approved Date</Text>
          <Text style={style.datestyle1}>22/04/2023</Text>
        </View>
      ...
      <View>
     <Text  style={style.expdes_head2}> Employer Comment </Text>

      <Text  style={style.expdes_des1}>Approved</Text>
...
export default approveExpDetails;
