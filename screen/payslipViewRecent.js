...
class payslipViewRecent extends Component {
  constructor(props) {
    super(props);
    this.state = {
      loading: true,
        ...
        <View style={styles.container}>
          ...
          <View style={styles.rowjustify1}>
            ...
            <Text style={styles.downloadicon}>
              ...
              <Icon
                color="black"
                name="download"
                onPress={() => Linking.openURL(data.PaySlipPath)}
                size={22}
                style={{color: '#7d7d7d'}}
              />
              </TouchableOpacity>
          ...
          <View
            ...
            <View style={styles.listrow}>
              ...
              <Text style={styles.lastname}>{data.FirstName}</Text>
            </View>
            <View style={styles.listrow}>
            ...
            <View style={styles.listrow}>
              <Text style={styles.firstname}>Gross Pay</Text>
              <Text style={styles.grosspay}>£{data.GrossSalary}</Text>
            </View>
          </View>
          ...
          <View
            ...
            <View style={styles.listrow}>
              <Text style={styles.firstname}>Income Tax</Text>
              <Text style={styles.lastname}>£{data.Tax}</Text>
            </View>
            <View style={styles.listrow}>
              <Text style={styles.firstname}>EE NI</Text>
              <Text style={styles.lastname}>£{data.EmployeeNI}</Text>
            </View>
            <View style={styles.listrow}>
              <Text style={styles.firstname}>EE Pension</Text>
              <Text style={styles.lastname}>£{data.EmployeePension}</Text>
            </View>
            <View style={styles.listrow}>
              <Text style={styles.firstname}>Loan Repayment</Text>
              <Text style={styles.lastname}>£{data.LoanRepayment}</Text>
            </View>
          </View>
          <View
            style={{
            ...
            <View style={styles.listrow}>
              <Text style={styles.firstname}>ER NI</Text>
              <Text style={styles.lastname}>£{data.EmployerNI}</Text>
            </View>
            <View style={styles.listrow}>
              <Text style={styles.firstname}>ER Pension</Text>
              <Text style={styles.lastname}>£{data.EmployerPension}</Text>
            </View>
          </View>
          <View style={styles.listrow}>
            <Text style={styles.netpayheader}>Net Pay</Text>
            <Text style={styles.netpayamnt}>£{data.NetSalary}</Text>
          </View>
          ...
          <View style={{flex: 1, flexDirection: 'column-reverse'}}>
            <TouchableOpacity
              ...
              {/* <Image
                ...
                source={require('../images/bottomicon/app_icns_Plus_Icon.png')}
              /> */}
            </TouchableOpacity>
            {/* For bottomPopup */}
            <BottomPopup
...
export default payslipViewRecent;
