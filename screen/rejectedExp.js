...
const rejectedExp = ({route,navigation})=>{
  
    return (
        <View style={style.container}>

        <TouchableOpacity onPress={()=>navigation.navigate('expDetails')}>
      ...
      <View style={style.appexplist}>
       ...
       <View style={style.righticon} ><Text style={{textAlign:'right'}}>   <Icon name='times-circle'  size={20} color="#EC581F" /></Text></View>
      </View>
